...
\end{minted}
\caption{Kompatibilní struktura}\label{spirit-advancedrule}
\end{listing}
...
\end{minted}
% I can't use \verb here and underscore only works in math blocks (hence the \symbol) >:(
\caption{\texttt{on\symbol{95}success} metoda}\label{spirit-handler}
\end{listing}
